...
Abschließend wird das Ergebnis der Analyse der Klasse \textit{OutputFormat} übergeben, welche das Resultat aufbereitet und im \ac{HDFS} ablegt. \autoref{fig:DatenflussMapReduce} stellt den Datenfluss zur Verdeutlichung grafisch dar.
...
\begin{lstlisting}[language=Java,caption=Auszug der Methode Bootstrap:init(),label=lst:BootstrapInit]
...
\begin{lstlisting}[language=Java,caption=Auszug der run Methode,label=lst:AuszugRunMethode]
