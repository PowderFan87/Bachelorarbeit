...
Innerhalb der Infrastruktur werden drei verschiedene Serverarten unterschieden:

\textbf{1) Webserver:} Aktuell werden die Webseiten auf zwei physisch getrennten Webservern betrieben. Durch sie wird die Kommunikation zwischen den Clients und den \textit{Appservern} gesteuert (Annehmen von Requests und Senden des entsprechenden Response).

\textbf{2) Appserver}: Die Inhalte für die einzelnen Seiten werden durch die \textit{Appserver} bereitgestellt. Die Anzahl dieser ist nicht festgelegt, um auf schwankende Anforderungen schneller regieren zu können. Steigt die Last auf das System, können weitere \textit{Appserver} der Infrastruktur hinzugefügt werden.

\textbf{3) Infrastrukturserver}: Der \textit{Infrastrukturserver} überwacht das gesamte System. Alle Informationen über den Zustand der Infrastruktur werden auf diesem Server konsolidiert. Dazu gehören ebenfalls die Logfiles. Diese werden, sowohl vom \textit{Web}- wie auch \textit{Appserver}, auf einem \ac{NFS} abgelegt. Die entsprechenden Verzeichnisse werden über einen mount dem \textit{Infrastrukturserver} zugänglich gemacht. 
...
\begin{table}[h]
	...
	\begin{tabularx}{\textwidth}{| l | l | l | X |}
		\hline
		\rowcolor[HTML]{3531FF} 
		\multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Gruppe}}}} &
		\multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Property}}}} &
		\multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Standardwert}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Beschreibung}}}} \\ \hline
...
\begin{table}[h]
	...
	\begin{tabularx}{\textwidth}{| l | X | X | X |}
		\hline
		\rowcolor[HTML]{3531FF} 
		\multicolumn{1}{|l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Klasse}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Beschreibung}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Key}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Value}}}} \\ \hline
...
\begin{table}[h]
	...
	\begin{tabularx}{\textwidth}{| l | X |}
		\hline
		\rowcolor[HTML]{3531FF} 
		\multicolumn{1}{|l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Klasse}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Beschreibung}}}} \\ \hline
...
Wie das Datenflussdiagramm (\autoref{fig:DatenflussMapReduce}) in \autoref{subsec:DatenflussMapReduce} zeigt, werden die durch den \textit{Mapper} erzeugten Schlüssel-Wert-Paare, nach deren Partitionierung/Sortierung, an den \textit{Reducer} weitergegeben. Diese Übergabe ist in Zeile 11 und 18 von \autoref{lst:MethodeMap} zu sehen.
...
\begin{table}[h]
	...
	\begin{tabular}{| l | l | l | l |}
		\hline
		\rowcolor[HTML]{3531FF} 
		\multicolumn{1}{|l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Methode}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Best-Case}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Durchschnitt}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Worst-Case}}}} \\ \hline
...
\begin{table}[h]
	...
	\begin{tabular}{| l | l | l | r |}
		\hline
		\rowcolor[HTML]{3531FF} 
		\multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Serverart}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Gruppe}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{IP-Adresse}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Antwortzeit (in Sek.)}}}} \\ \hline
...
\begin{table}[h]
	\begin{subtable}[b]{.5\linewidth}
		\begin{tabular}{| l | r |}
			\hline
			\rowcolor[HTML]{3531FF} \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Gruppe}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Antwortzeit (in Sek.)}}}} \\ \hline
			AS1 & 4,5 \\ \hline
			AS2 & 2 \\ \hline
			AS3 & 3,5 \\ \hline
			CS1 & 1,5 \\ \hline
	...
	\begin{subtable}[b]{.5\linewidth}
		\begin{tabular}{| l | r |}
			\hline
			\rowcolor[HTML]{3531FF} 
			\multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Serverart}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Antwortzeit (in Sek.)}}}} \\ \hline
	...
	\end{subtable}
	\caption{Ergebnistabellen für Job B (a) und Job C (b)}
\end{table}
...
Für die Tests werden eine Reihe von Logfiles in unterschiedlichen Größen bereitgestellt. Diese enthalten $10$ bis $10^7$ Einträgen. Jedes Logfile wird 10 mal durch die Anwendung analysiert und die Laufzeit protokolliert. Die Analyse soll Fehlercodes anhand des definierten regulären Ausdrucks ermitteln und zählen. \autoref{lis:PropertiesAnwendungstest} zeigt die für die Tests verwendete Konfiguration. Der zu verwendende reguläre Ausdruck wird in Zeile 14 definiert. \\
...
lfa.mapper.pattern.key   : \\] ([A-Z]{3,6})
lfa.mapper.nomatchaction : SKIP
\end{lstlisting}

\newpage
Bei jeder Ausführung des Programms erfolgt über ein eigens entwickeltes Bash-Script, welches die Logfiles vor jede Analyse neu in das \ac{HDFS} überträgt. Dies ist notwendig, da bei jedem Upload die Datenblöcke neu geschrieben werden müssen, um ein verfälschtes Ergebnis durch Caching zu vermeiden. \autoref{lis:Ergebnisdatei} zeigt, als Beispiel, den Inhalt einer Ergebnisdatei des Tests Nr. 6 ($2,5 \times 10^5$ Einträge). Die Schlüssel-Wert-Paare werden Zeilenweise geschrieben. Schlüssel und Wert werden durch einen Tabulator getrennt. \\

\begin{lstlisting}[language=bash,caption=Inhalt der Ergebnisdatei \textit{part-r-00000},label=lis:Ergebnisdatei]
ERROR   95348
INFO    78384
WARN    76268
\end{lstlisting}
...
\begin{table}[h]
	...
	\begin{tabular}{| r | l | r | r |}
		\hline
		\rowcolor[HTML]{3531FF} 
		\multicolumn{1}{|l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{\#}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Anzahl Einträge}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Dateigröße}}}} & \multicolumn{1}{l|}{\cellcolor[HTML]{4F88BB}{\color[HTML]{FFFFFF} {\textbf{Laufzeit}}}} \\ \hline
...
%Da die Tests auf der in \autoref{sec:InstallationHadoop} erwähnten \ac{VM} durchgeführt wurden, können die im folgenden getroffenen Aussagen vom späteren produktiven Betrieb abweichen.
